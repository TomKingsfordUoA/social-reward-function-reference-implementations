...
class CoSpeechGestureGenerator(abc.ABC):
    def __init__(self, pythonpaths: typing.List[str], pymo_path: str) -> None:
    ...
    def manage_dependencies(self):
        ...
        for path in reversed(self._pythonpaths):
            sys.path.insert(0, path)

        pymo_modules = [
            os.path.splitext(filename)[0]
            for filename in os.listdir(self._pymo_path)
        ]
        ...
        for mod_name in pymo_modules:
            ...
            pymo_data_spec = importlib.util.spec_from_file_location(mod_name, os.path.join(self._pymo_path, mod_filename))
