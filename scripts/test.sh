...
PYTHONPATH=$(pwd) python srf_reference_implementations/cli.py -t srf_reference_implementations/interfaces/test_resources/GENEA_sample_transcript.json -o test_output_dir
rm -r test_output_dir || true
